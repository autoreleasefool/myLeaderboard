...
var Octokat = require("./octokat.js");
// @ts-ignore Octokat isn't playing nice with TS, so ignore the error that it's not a constructor.
var octo = new Octokat({ token: "0c0e108b89e8cfbe1682eb0f030affc8a278cd63" });
var repo = octo.repos("josephroquedev", "myLeaderboard");
repo.commits.fetch()
    .then(function (info) {
    var sha = info.items[0];
    console.log(sha);
});
function fetchLatestCommit() {
}
fetchLatestCommit();
// // function testCommit(prevSha, content) {
// //     var config = {
// //         message: "Testing file update",
...
// //     repo.commits.fetch()
// //         .then(function (info) {
// //             var sha = info.items[0].sha;
// //         })
// // }
// // var repo = octo.repos("josephroquedev", "myLeaderboard");
// // repo.contents("README.md").read()
...
},{"./octokat.js":2}],2:[function(require,module,exports){
