...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    return /******/ (function (modules) {
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _require = __webpack_require__(0), filter = _require.filter, forOwn = _require.forOwn, extend = _require.extend;
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var ALL_PLUGINS = [__webpack_require__(18),
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            /* WEBPACK VAR INJECTION */ (function (global) {
                ...
                var _require = __webpack_require__(5), VerbMethods = _require.VerbMethods, toPromise = _require.toPromise;
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _require = __webpack_require__(0), filter = _require.filter, map = _require.map;
            // Request Function
            // ===============================
            //
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var TREE_OPTIONS = __webpack_require__(3);
            var _require = __webpack_require__(5), VerbMethods = _require.VerbMethods;
            var Chainer = __webpack_require__(4);
            module.exports = new (function () {
            ...
            module.exports = new (function () {
                ...
                _createClass(CacheHandler, [{
                        ...
                        value: function responseMiddlewareAsync(input, cb) {
                            var clientOptions = input.clientOptions, request = input.request, status = input.status, jqXHR = input.jqXHR, data = input.data;
                            if (!jqXHR) {
                                return Promise.resolve(input);
                            } // The plugins are all used in `octo.parse()` which does not have a jqXHR
                            // Since this can be called via `octo.parse`, skip caching when there is no jqXHR
                            if (jqXHR) {
                                var method = request.method, path = request.path; // This is also not defined when octo.parse is called
                                var cacheHandler = clientOptions.cacheHandler || this;
...
function parseRawStandings(game, contents) {
    ...
    let worstRecord = { player: null, record: Infinity };
    for (let player in json) {
        players.push(player);
        let playerRecord = { wins: 0, losses: 0, ties: 0, isBest: false, isWorst: false };
        let bestOpponentRecord = { player: null, record: -Infinity };
        let worstOpponentRecord = { player: null, record: Infinity };
        ...
        for (let opponent in json[player]) {
            if (opponent == bestOpponentRecord.player) {
                ...
                matchRecord.set(opponent, Object.assign({}, opponentRecord, { isBest: true }));
                matchRecords.set(player, matchRecord);
            }
            if (opponent == worstOpponentRecord.player) {
                let matchRecord = matchRecords.get(player);
                let opponentRecord = matchRecord.get(opponent);
                matchRecord.set(opponent, Object.assign({}, opponentRecord, { isWorst: true }));
                matchRecords.set(player, matchRecord);
            }
        }
