...
public extension MyLeaderboardAPI {
	struct StandingsQuery: GraphApiQuery, ResponseAssociable, Equatable {
		...
		fragment StandingsGameFragment on Game { __typename id name image } fragment StandingsFragment on Game { __typename standings { __typename records { __typename ... StandingsPlayerRecordFragment } } } fragment StandingsPlayerRecordFragment on PlayerRecord { __typename player { __typename ... OpponentFragment } record { __typename ... StandingsPlayerGameRecordFragment } } fragment OpponentFragment on BasicPlayer { __typename id avatar } fragment StandingsPlayerGameRecordFragment on PlayerGameRecord { __typename lastPlayed overallRecord { __typename ... RecordFragment } records { __typename opponent { __typename ... OpponentFragment } record { __typename ... RecordFragment } } } fragment RecordFragment on Record { __typename wins losses ties isBest isWorst } query Standings($first: Int!, $offset: Int!) { __typename games(first: $first, offset: $offset) { __typename ... StandingsGameFragment ... StandingsFragment } }
		"""
	}
}
