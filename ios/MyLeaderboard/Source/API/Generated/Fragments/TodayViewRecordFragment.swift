...
struct TodayViewRecordFragment: GraphApiResponse, Equatable {
	...
	public init(game: Game, overallRecord: OverallRecord, records: [Records]) {
		...
		// MARK: - Response Fields
			...
			public var id: GraphID {
				get {
					return asTodayViewGameFragmentFragment.id
				}
				set {
					asTodayViewGameFragmentFragment.id = newValue
				}
			}
			/// Image for the game.
			public var image: String? {
				get {
					return asTodayViewGameFragmentFragment.image
				}
				set {
					asTodayViewGameFragmentFragment.image = newValue
				}
			}
			public var asTodayViewGameFragmentFragment: MyLeaderboardAPI.TodayViewGameFragment
		// MARK: - Helpers
		public let __typename: String
		public static let customDecoder: JSONDecoder = MyLeaderboardAPI.customDecoder
		public static let customEncoder: JSONEncoder = MyLeaderboardAPI.customEncoder
			private enum CodingKeys: String, CodingKey {
				case __typename
					case asTodayViewGameFragmentFragment = "fragment:asTodayViewGameFragmentFragment"
			}
			public init(from decoder: Decoder) throws {
				let container = try decoder.container(keyedBy: CodingKeys.self)
				self.__typename = try container.decode(String.self, forKey: .__typename)
					do {
						self.asTodayViewGameFragmentFragment = try MyLeaderboardAPI.TodayViewGameFragment(from: decoder)
					} catch let originalError {
						do {
							self.asTodayViewGameFragmentFragment = try container.decode(MyLeaderboardAPI.TodayViewGameFragment.self, forKey: .asTodayViewGameFragmentFragment)
						} catch {
								throw originalError
						}
					}
			}
		public init(todayViewGameFragmentFragment: MyLeaderboardAPI.TodayViewGameFragment) {
				self.asTodayViewGameFragmentFragment = todayViewGameFragmentFragment
